...
@section('content')
    <div class="container-fluid">
        <h1>Biller Hana Chart</h1>

        <form method="GET" action="{{ route('biller.billerhanachart') }}" class="form-inline mb-4">
        ...
        <biller-hana-chart :data='@json($chartData)'></biller-hana-chart>
    </div>
@endsection
