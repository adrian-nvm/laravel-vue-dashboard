    ...
    <div class="card-header py-3">
      <div class="d-flex flex-row align-items-center justify-content-between">
        <div class="d-flex align-items-center">
          <h6 class="m-0 font-weight-bold text-primary">QRIS Line Bank</h6>
  ...
  methods: {
    ...
    async fetchLineData() {
      ...
      try {
        ...
        let url = `/qris/qris-line-data?page=${page}&per_page=${per_page}&start_dt=${start_dt}&start_month=${start_month}&end_month=${end_month}`;
    ...
    async exportLineData() {
      try {
        const response = await axios.get('/qris/qris-line-data?per_page=-1');
