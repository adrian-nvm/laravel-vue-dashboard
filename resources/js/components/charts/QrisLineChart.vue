...
export default {
    ...
    methods: {
        ...
        processData(data) {
            const sortedData = [...data].sort((a, b) => new Date(a.period || a.startDt) - new Date(b.period || a.startDt));
            ...
            if (this.selectedChartType === 'pie') {
                return {
                    ...
                    datasets: [{
                        ...
                        data: sortedData.map(item => item.qrisTrxAmt || 0),
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.8)',
                            'rgba(54, 162, 235, 0.8)',
                            'rgba(255, 206, 86, 0.8)',
            ...
            // Default to line/bar chart data
            return {
                labels,
                datasets: [
                    {
                    ...
                    },
                    {
                        ...
                        data: sortedData.map(item => item.qrisTrxFreq || 0),
                    ...
                    {
                        label: 'Unique CIF',
                        data: sortedData.map(item => item.qrisUniqueCifQty || 0),
            ...
            if (this.selectedChartType === 'pie') {
                ...
                options = {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'QRIS Transaction Amount Distribution',
                ...
                type = this.selectedChartType === 'area' ? 'line' : 'bar'; // The mixed chart's base type is bar
                options = {
                    responsive: true,
                    maintainAspectRatio: false,
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'QRIS Transaction - Line Bank',
                            font: { size: 25, weight: 'bold' }
                        },
                        legend: {
                            display: true,
