<template>
    ...
    <div class="chart-header mb-3 d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
          <h4>QRIS Transaction Analytics (MyHana)</h4>
            ...
            if (this.selectedChartType === 'pie') {
                return {
                    ...
                    datasets: [{
                        ...
                        data: sortedData.map(item => item.qrisMyhanaTrxAmt || 0),
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.8)',
                            'rgba(54, 162, 235, 0.8)',
                            'rgba(255, 206, 86, 0.8)',
            ...
            return {
                ...
                datasets: [
                    ...
                    },
                    {
                        ...
                        data: sortedData.map(item => item.qrisMyhanaTrxFreq || 0),
                    ...
                    {
                        label: 'Unique CIF',
                        data: sortedData.map(item => item.qrisMyhanaUniqueCifQty || 0),
            ...
            if (this.selectedChartType === 'pie') {
                ...
                options = {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'QRIS MyHana Transaction Amount Distribution',
                ...
                options = {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'QRIS Transaction - Hana Bank',
                            font: { size: 25, weight: 'bold' }
                        },
                        legend: {
                            display: true,
