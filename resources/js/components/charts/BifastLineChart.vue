<template>
    ...
    <div class="chart-header mb-3 d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
          <h4>Bifast Transaction Analytics</h4>
            ...
            if (this.selectedChartType === 'pie') {
                return {
                    ...
                    datasets: [{
                        ...
                        data: sortedData.map(item => item.bifastTrxAmt || 0),
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.8)',
                            'rgba(54, 162, 235, 0.8)',
                            'rgba(255, 206, 86, 0.8)',
            ...
            return {
                ...
                datasets: [
                    ...
                    },
                    {
                        ...
                        data: sortedData.map(item => item.bifastTrxFreq || 0),
                    ...
                    {
                        label: 'Unique CIF',
                        data: sortedData.map(item => item.bifastUniqueCifQty || 0),
            ...
            if (this.selectedChartType === 'pie') {
                ...
                options = {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'Bifast Transaction Amount Distribution',
                ...
                options = {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'Bifast Transaction - Line Bank',
                            font: { size: 25, weight: 'bold' }
                        },
                        legend: {
                            display: true,
