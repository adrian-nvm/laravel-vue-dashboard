            ...
            if (this.selectedChartType === 'pie') {
                return {
                    ...
                    datasets: [{
                        ...
                        data: sortedData.map(item => item.billMyhanaTrxAmt || 0),
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.8)',
                            'rgba(54, 162, 235, 0.8)',
                            'rgba(255, 206, 86, 0.8)',
            ...
            return {
                ...
                datasets: [
                    ...
                    },
                    {
                        ...
                        data: sortedData.map(item => item.billMyhanaTrxFreq || 0),
                    ...
                    {
                        label: 'Unique CIF',
                        data: sortedData.map(item => item.billMyhanaUniqueCifQty || 0),
            ...
            if (this.selectedChartType === 'pie') {
                ...
                options = {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'Biller MyHana Transaction Amount Distribution',
                ...
                options = {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'Biller Transaction - Hana Bank',
                            font: { size: 25, weight: 'bold' }
                        },
                        legend: {
                            display: true,
