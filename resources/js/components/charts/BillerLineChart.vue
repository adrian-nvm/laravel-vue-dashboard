            ...
            if (this.selectedChartType === 'pie') {
                return {
                    ...
                    datasets: [{
                        ...
                        data: sortedData.map(item => item.billTrxAmt || 0),
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.8)',
                            'rgba(54, 162, 235, 0.8)',
                            'rgba(255, 206, 86, 0.8)',
            ...
            return {
                ...
                datasets: [
                    ...
                    },
                    {
                        ...
                        data: sortedData.map(item => item.billTrxFreq || 0),
                    ...
                    {
                        label: 'Unique CIF',
                        data: sortedData.map(item => item.billUniqueCifQty || 0),
            ...
            if (this.selectedChartType === 'pie') {
                ...
                options = {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'Biller Transaction Amount Distribution',
                ...
                options = {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'Biller Transaction - Line Bank',
                            font: { size: 25, weight: 'bold' }
                        },
                        legend: {
                            display: true,
