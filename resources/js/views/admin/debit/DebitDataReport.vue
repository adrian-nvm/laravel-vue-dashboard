<template>
  <div>
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Debit Data Report</h1>
  ...
  methods: {
    ...
    async fetchHanaData() {
      ...
      try {
        ...
        let url = `/debit/debit-hana-data?page=${page}&per_page=${per_page}&start_dt=${start_dt}&start_month=${start_month}&end_month=${end_month}`;
